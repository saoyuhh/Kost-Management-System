...
The system is built on a normalized relational schema with 5 core entities to ensure data integrity:
1.	Users: Authentication and role management.
2.	Rooms: Tracking room types, prices, and availability.
3.	Residents: Detailed tenant personal and stay information.
4.	Payments: Transaction history and verification status.
5.	Maintenance: Workflow management for facility repairs.

🚀 Installation & Setup
-	Clone this repository to your local machine.
-	Import the provided SQL file (e.g., kost_db.sql) into your MySQL server (via phpMyAdmin/XAMPP).
-	Update the database connection settings in the configuration file.
-	Run the project through your local server environment.
